# [Module 2 · 2.1-prompting] Prompting : system prompts, XML, few-shot, output constraints & structured outputs

Source : Prep Course CCDV-F officiel (Anthropic Partner Academy), Module 2 — Production-Grade Prompting, Agents & Tool-use.
Blueprint couvert : Prompt Engineering (4,6%), Output Handling (2,6%)
...
System PromptsXML TagsFew-shot ExamplesOutput Constraints
