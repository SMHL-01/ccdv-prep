...
**19 / 27 topics valides, 0 reserve par Said, 8 proposes a Marie-Line**
...
**Cibles : 284 questions pour la banque, 86 restant a ecrire sur 8 topics.**
...
| | Topic | Ecrites | Qui |
| --- | --- | ---: | --- |
| `[x]` | m4-4.1-evals | 12 | Marie-Line |
| `[x]` | m4-4.2-testing-tracing | 9 | Marie-Line |
