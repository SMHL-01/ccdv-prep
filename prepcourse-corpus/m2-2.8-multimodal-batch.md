# [Module 2 · 2.8-multimodal-batch] Images, PDFs & Batch API

Source : Prep Course CCDV-F officiel (Anthropic Partner Academy), Module 2 — Production-Grade Prompting, Agents & Tool-use.
Blueprint couvert : Claude Application Design (8,6%), Cost & Token Mgmt (2,8%)
...
Inline base64URL referenceFiles API
