# [Module 3 · 3.2-claudemd] CLAUDE.md, rules, hooks & subagents

Source : Prep Course CCDV-F officiel (Anthropic Partner Academy), Module 3.
Blueprint couvert : Configuration Management (4,1%), Claude Code (3,1%)
