...
**359 / 400 questions** — **87.8 %** du poids de l'examen couvert — **19 / 25** sous-domaines termines.
...
| Marie-Line (Claude Code, acces direct GitHub -> gros sous-domaines) | 10 | 1 | 236 |
...
| | Sous-domaine | Ecrites | Cible | Poids | Qui |
| --- | --- | ---: | ---: | ---: | --- |
| `[x]` | Claude Code | 12 | 12 | 3.1 % | Marie-Line (Claude Code, acces direct GitHub -> gros sous-domaines) |
...
| `[x]` | Model Selection and Tradeoffs | 11 | 11 | 2.7 % | Marie-Line (Claude Code, acces direct GitHub -> gros sous-domaines) |
| `[x]` | Cost and Token Management <br><sub>20 questions dont 1 factual_magnitude a 5.0% (plafond 5%/fichier respecte)</sub> | 20 | 11 | 2.8 % | Marie-Line (Claude Code, acces direct GitHub -> gros sous-domaines) |
