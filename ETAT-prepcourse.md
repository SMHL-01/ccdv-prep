...
**12 / 27 topics valides, 0 reserve par Said, 15 proposes a Marie-Line**
...
**Cibles : 284 questions pour la banque, 164 restant a ecrire sur 15 topics.**
...
| `[ ]` | m2-2.8-multimodal-batch | 0 | Marie-Line (propose) |
...
| `[ ]` | m3-3.5-enterprise | 0 | Marie-Line (propose) |
