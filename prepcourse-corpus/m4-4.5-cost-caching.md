# [Module 4 · 4.5-cost-caching] Cost, latency & caching

Source : Prep Course CCDV-F officiel (Anthropic Partner Academy), Module 4.
Blueprint couvert : Cost and Token Management (2,8%)
...
Model selectionPrompt & context sizeNumber of tool callsStreamed vs. batchedStreaming with tool use
