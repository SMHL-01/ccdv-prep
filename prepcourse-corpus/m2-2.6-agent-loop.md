# [Module 2 · 2.6-agent-loop] Production agent : loop, wiring paths, orchestration & HITL

Source : Prep Course CCDV-F officiel (Anthropic Partner Academy), Module 2 — Production-Grade Prompting, Agents & Tool-use.
Blueprint couvert : Agent Architecture (4,5%), Agent Construction (5,3%)
...
Raw Messages API loopAgent SDKClaude Managed Agents
