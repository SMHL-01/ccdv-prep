# [Module 1 · 1.4-technical-substrate] Technical substrate : SDK, REST, streaming, async

Source : Prep Course CCDV-F officiel (Anthropic Partner Academy), Module 1 — MSO Foundations.
Blueprint couvert : Technical Fundamentals (6,1%), Claude API Mechanics (6,8%)
